...
if __name__ == "__main__":
    ...
    for Max_Sensors in [10]:
        ...
        print("to generate edges ",(time.time()-start_time))
        start_time = time.time()
        graph = Graph.Graph(len(Sensors),edges)   
        connected_components=graph.connectedComponents()
        print("conected components ",(time.time()-start_time))
        start_time = time.time()
        ...
        for cc in connected_components:
            ...
            for i in indices:
                ...
                cc_num +=1
        print("gateways",(time.time()-start_time))
        ...
        pd.DataFrame(data=output).to_csv('D:/Assignments/Algo/impl/lora_graph_gw/Pre_Study/ConnectedComponent/files/gateways_Placement_Scenario_cc.csv')
        ...
        pd.DataFrame(data=output).to_csv('D:/Assignments/Algo/impl/lora_graph_gw/Pre_Study/ConnectedComponent/files/reachable_sensors_Placement_Scenario_1.csv')
        pd.DataFrame(data=output).to_json('D:/Assignments/Algo/impl/lora_graph_gw/Pre_Study/ConnectedComponent/files/reachable_sensors_Placement_Scenario_1.json')
