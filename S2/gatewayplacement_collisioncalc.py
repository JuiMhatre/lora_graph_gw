...
sensor_files = "/home/jmhare1/gatewayPlacement/lora_graph_gw/S2/files/reachable_sensors*.json"
gateway_files = "/home/jmhare1/gatewayPlacement/lora_graph_gw/S2/files/gateways_Placement_*.csv"
#%%
...
for i in range(len(sensor_data_paths)):
    ...
    outputPath = sensor_data_paths[i].replace('/home/jmhare1/gatewayPlacement/lora_graph_gw/S2/files/reachable_sensors', '/home/jmhare1/gatewayPlacement/lora_graph_gw/S2/files/sensors_transmissionrange')
