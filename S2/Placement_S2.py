...
def create_placement(vars):
    ...
    pd.DataFrame(data=output).to_csv('/home/jmhare1/gatewayPlacement/lora_graph_gw/S2/files/gateways_Placement_Max_Sensors'+str(int(Max_Sensors))+'.csv')
    ...
    pd.DataFrame(data=output).to_csv('/home/jmhare1/gatewayPlacement/lora_graph_gw/S2/files/reachable_sensors_Max_Sensors'+str(int(Max_Sensors))+'.csv')
    pd.DataFrame(data=output).to_json('/home/jmhare1/gatewayPlacement/lora_graph_gw/S2/files/reachable_sensors_Max_Sensors'+str(int(Max_Sensors))+'.json')
